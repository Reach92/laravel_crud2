...
class SubjectControllerTest extends TestCase
{
     ...
     * @test
     */
    public function it_displays_index_view_with_subjects()
    {
     ...
     * @test
     */
    public function it_displays_create_view_for_subject()
    {
     ...
     * @test
     */
    public function it_stores_the_subject()
    {
     ...
     * @test
     */
    public function it_displays_show_view_for_subject()
    {
     ...
     * @test
     */
    public function it_displays_edit_view_for_subject()
    {
        $subject = Subject::factory()->create();
     ...
     * @test
     */
    public function it_updates_the_subject()
    {
        $subject = Subject::factory()->create();
     ...
     * @test
     */
    public function it_deletes_the_subject()
    {
        $subject = Subject::factory()->create();
